...
class AlbumsListViewModel {
    ...
    private func fetchTopAlbums(withCompletion completion: @escaping AlbumsCompletion) {
        ...
        // Get the url
        let urlString = "https://rss.itunes.apple.com/api/v1/us/apple-music/top-songs/all/10/explicit.json"
    ...
    func fetchAlbumImage(withURL urlString: String, completion: @escaping ImageDownloadCompletion) {
